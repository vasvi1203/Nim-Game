...
class Nim():
	...
	def menuSetup(self):
		...
		PvsAIMenu.add_text_input(
			"Player Name : ",
			default = "Human",
			textinput_id = "playerName"
			)

		PvsAIMenu.add_button("Play", self.setMode1, PvsAIMenu)

		PvsAIMenu.add_button("Back", pygame_menu.events.BACK)

		PvsAIMenu.add_button("Quit", pygame_menu.events.EXIT)
		...
		modeMenu.add_button("Against AI", PvsAIMenu)
